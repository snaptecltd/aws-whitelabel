    ...
    <div class="row">
        <div class="col-md-6">
            <form style="float:left" method="POST">
                ...
                <div class="row mb-4">
                    <div class="col-md-12 pr-0 form-groups-bottom-0">
                        <p>{{ $data['domain'] }} | Zone: {{ $data['zone'] }} <a href="{{ action('\Snaptec\Plugin\AwsWhitelabel\Controllers\MainController@selectDomain') }}" class="btn btn-link" style="color: #333">+ Change domain</a></p>
                    </div>
                </div>
                <div class="">
                    @if (!$plugin->isActive())
                    
                        <input type="submit" formaction="{{ action('\Snaptec\Plugin\AwsWhitelabel\Controllers\MainController@activate') }}" value="Activate">
                    
                    @endif
                    
                    <input type="submit" formaction="{{ action('\Snaptec\Plugin\AwsWhitelabel\Controllers\MainController@reset') }}" value="Reset Connection">
