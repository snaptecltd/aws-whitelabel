...
namespace Snaptec\Plugin\AwsWhitelabel\Controllers;

use Snaptec\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Snaptec\Plugin\AwsWhitelabel\Main;
use Snaptec\Model\SendingServer;
...
class MainController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!array_key_exists('aws_key', $data) || !array_key_exists('aws_secret', $data)) {
            return redirect()->action('\Snaptec\Plugin\AwsWhitelabel\Controllers\MainController@editKey');
        }

        if (!array_key_exists('zone', $data) || !array_key_exists('domain', $data)) {
            return redirect()->action('\Snaptec\Plugin\AwsWhitelabel\Controllers\MainController@selectDomain');
        }
    ...
    public function saveDomain(Request $request)
    {
        ...
        return redirect()->action('\Snaptec\Plugin\AwsWhitelabel\Controllers\MainController@index');
    }
    ...
    public function popup(Request $request, $uid)
    {
        ...
        $plugin = \Snaptec\Model\Plugin::getByName('snaptec/aws-whitelabel');
